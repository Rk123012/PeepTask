...
public class CameraLocationData {
    public  static ArrayList<CameraLocation> getCameraLocation(){
        ...
        cameraInfos.add(new CameraLocation("mirpur -1", "Camera - 1", 23.7956, 90.3537,true,1));
        cameraInfos.add(new CameraLocation("mirpur -1", "Camera - 2", 23.7958, 90.3535,true,1));
        cameraInfos.add(new CameraLocation("mirpur -1", "Camera - 3", 23.7954, 90.3533,true,1));
